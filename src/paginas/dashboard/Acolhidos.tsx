                ...
                <div className='container-painel'>
                    <div className="todosCards">
                        <div className="cardAcolhidos">
                            ...
                            <h1>Cachorro tuco</h1>
                            <p>
                                Tuco foi adotado pela andressa no bairro de santa maria em bauru no dia 15/02 com o nosso auxílio e a ajuda da ONG FUIPA
                                para tratamento do doguinho
                            </p>
                            <div className="riscoVerde"></div>
                        </div>
