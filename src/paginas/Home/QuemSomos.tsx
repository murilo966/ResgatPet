    ...
    return(
        <div>
            ...
            <div className='container'>
                ...
                <div className='text2'> 
                    <p  >Somos um grupo de alunos do curso de desenvolvimento full stack do Senac Bauru 2023-2024, que, motivados pelo amor aos animais, decidimos desenvolver um site para auxiliar o resgate de animais em situação de rua e abandono.  </p>
